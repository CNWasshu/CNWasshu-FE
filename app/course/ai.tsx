...
const styles = StyleSheet.create({
  ...
  errorBox: { alignItems: 'flex-start', backgroundColor: '#FFF9F6', borderWidth: 1, borderColor: '#E6BDB3', borderRadius: 14, flexDirection: 'row', gap: 9, padding: 13 }, errorContent: { flex: 1, gap: 3 }, errorTitle: { color: CourseColors.text, fontSize: 14, fontWeight: '900' }, error: { color: CourseColors.error, fontSize: 12, lineHeight: 18 }, errorHint: { color: CourseColors.muted, fontSize: 11, lineHeight: 17, marginTop: 2 },
