...
const styles = StyleSheet.create({
  ...
  loading: { backgroundColor: CourseColors.white, borderRadius: 18, borderWidth: 1, borderColor: CourseColors.border, padding: 28, alignItems: 'center', gap: 10 }, loadingIcon: { width: 58, height: 58, borderRadius: 29, backgroundColor: CourseColors.primarySoft, alignItems: 'center', justifyContent: 'center' }, loadingTitle: { color: CourseColors.text, fontSize: 17, fontWeight: '900', marginTop: 3 }, muted: { color: CourseColors.muted, textAlign: 'center', fontSize: 13 }, errorBox: { alignItems: 'flex-start', backgroundColor: '#FFF9F6', borderWidth: 1, borderColor: '#E6BDB3', borderRadius: 14, flexDirection: 'row', gap: 9, padding: 13 }, errorContent: { flex: 1, gap: 3 }, errorTitle: { color: CourseColors.text, fontSize: 14, fontWeight: '900' }, error: { color: CourseColors.error, fontSize: 12, lineHeight: 18 },
