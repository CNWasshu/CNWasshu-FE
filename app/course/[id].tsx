        ...
        <ScrollView contentContainerStyle={styles.container}>
          <View style={styles.hero}>
            ...
            <View style={styles.titleRow}>
              ...
              <Pressable accessibilityLabel="코스 공유하기" accessibilityRole="button" disabled={sharing} hitSlop={8} onPress={() => void handleShare()} style={({ pressed }) => [styles.shareButton, (pressed || sharing) && styles.shareButtonPressed]}>
...
const styles = StyleSheet.create({
  ...
  shareButton: { alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.12)', borderColor: 'rgba(255,255,255,0.28)', borderRadius: 12, borderWidth: 1, flexShrink: 0, height: 42, justifyContent: 'center', width: 42 }, shareButtonPressed: { opacity: 0.55 },
});
