...
const styles = StyleSheet.create({
  ...
  hero: { backgroundColor: CourseColors.hero, paddingHorizontal: 18, paddingTop: 18, paddingBottom: 26, borderBottomLeftRadius: 28, borderBottomRightRadius: 28, width: '100%' }, heroDesktop: { borderBottomLeftRadius: 0, borderBottomRightRadius: 0, paddingBottom: 30, paddingHorizontal: 24, paddingTop: 24 }, heroInner: { alignSelf: 'center', gap: 10, maxWidth: PAGE_LAYOUT.desktopMaxWidth, width: '100%' }, detailHeader: { alignItems: 'center', flexDirection: 'row', gap: 10 }, detailHeaderTitle: { color: CourseColors.white, fontSize: 18, fontWeight: '800' }, typeBadge: { alignSelf: 'flex-start', color: CourseColors.primaryDark, backgroundColor: '#E9F4E6', borderRadius: 8, paddingHorizontal: 9, paddingVertical: 4, fontWeight: '800', fontSize: 12, overflow: 'hidden' }, titleRow: { alignItems: 'center', flexDirection: 'row', gap: 12 }, title: { color: CourseColors.white, flex: 1, fontSize: 26, fontWeight: '900', lineHeight: 34 }, summaryRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 16, marginTop: 2 }, summaryItem: { alignItems: 'center', flexDirection: 'row', gap: 5 }, summaryText: { color: '#F4FAF2', fontSize: 13, fontWeight: '700' },
  content: { width: '100%', maxWidth: PAGE_LAYOUT.desktopMaxWidth, alignSelf: 'center', paddingHorizontal: 16, marginTop: 24, gap: 28 }, mapSection: { backgroundColor: CourseColors.white, borderRadius: 18, borderWidth: 1, borderColor: CourseColors.border, padding: 15, gap: 13 }, scheduleSection: { gap: 16 }, sectionHeading: { flexDirection: 'row', alignItems: 'center', gap: 8 }, sectionTitle: { color: CourseColors.text, fontSize: 19, fontWeight: '900' },
