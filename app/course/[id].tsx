...
export default function CourseDetailScreen() {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['bottom']}>
      <Stack.Screen options={{ title: '코스 상세', headerBackTitle: '목록', headerStyle: { backgroundColor: CourseColors.primary }, headerTintColor: CourseColors.white, headerShadowVisible: false }} />
