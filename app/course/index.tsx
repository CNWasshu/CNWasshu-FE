...
const styles = StyleSheet.create({
  ...
  listSection: { gap: 13 }, sectionHeading: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10 }, sectionTitleWrap: { flexShrink: 1 }, sectionTitle: { color: CourseColors.text, fontSize: 21, fontWeight: '900' }, sectionCount: { color: CourseColors.primary, fontSize: 17, fontWeight: '900' }, smallAiButton: { alignItems: 'center', backgroundColor: CourseColors.primary, borderRadius: 14, flexDirection: 'row', gap: 5, minHeight: 44, paddingHorizontal: 11 }, smallAiButtonPressed: { backgroundColor: CourseColors.primaryDark, opacity: 0.9 }, aiSparkle: { color: '#EAF5E7', fontSize: 11, fontWeight: '900' }, smallAiText: { color: CourseColors.white, fontWeight: '900', fontSize: 14 }, smallAiArrow: { color: CourseColors.white, fontWeight: '700', fontSize: 16 },
  controls: { gap: 9, position: 'relative', zIndex: 100 }, filterRow: { gap: 7, paddingRight: 4 }, filterChip: { alignItems: 'center', backgroundColor: '#FFFCF7', borderColor: CourseColors.border, borderRadius: 999, borderWidth: 1, flexDirection: 'row', gap: 4, minHeight: 38, paddingHorizontal: 13 }, filterChipSelected: { backgroundColor: CourseColors.primary, borderColor: CourseColors.primary }, filterChipText: { color: CourseColors.text, fontSize: 13, fontWeight: '800' }, filterChipTextSelected: { color: CourseColors.white }, controlPressed: { opacity: 0.72 }, statusFilterWrap: { alignItems: 'flex-end', position: 'relative', zIndex: 101 }, statusFilterButton: { alignItems: 'center', alignSelf: 'flex-end', backgroundColor: CourseColors.white, borderColor: CourseColors.border, borderRadius: 12, borderWidth: 1, flexDirection: 'row', gap: 5, minHeight: 40, paddingHorizontal: 11 }, statusFilterButtonText: { color: CourseColors.primaryDark, fontSize: 13, fontWeight: '800' }, statusFilterMenu: { backgroundColor: CourseColors.white, borderColor: CourseColors.border, borderRadius: 14, borderWidth: 1, elevation: 12, minWidth: 158, overflow: 'hidden', position: 'absolute', right: 0, shadowColor: '#40382C', shadowOffset: { width: 0, height: 5 }, shadowOpacity: 0.18, shadowRadius: 12, top: 45, zIndex: 102 }, statusFilterOption: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', minHeight: 42, paddingHorizontal: 12 }, statusFilterOptionText: { color: CourseColors.text, fontSize: 13, fontWeight: '700' }, statusFilterOptionSelected: { backgroundColor: CourseColors.primarySoft }, statusFilterOptionTextSelected: { color: CourseColors.primaryDark, fontWeight: '900' },
