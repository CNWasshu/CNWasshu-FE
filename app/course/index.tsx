...
const styles = StyleSheet.create({
  ...
  controls: { gap: 9 }, filterRow: { gap: 7, paddingRight: 4 }, filterChip: { alignItems: 'center', backgroundColor: '#FFFCF7', borderColor: CourseColors.border, borderRadius: 999, borderWidth: 1, flexDirection: 'row', gap: 4, minHeight: 38, paddingHorizontal: 13 }, filterChipSelected: { backgroundColor: CourseColors.primary, borderColor: CourseColors.primary }, filterChipText: { color: CourseColors.text, fontSize: 13, fontWeight: '800' }, filterChipTextSelected: { color: CourseColors.white }, controlPressed: { opacity: 0.72 }, statusFilterWrap: { alignItems: 'flex-end', position: 'relative', zIndex: 2 }, statusFilterButton: { alignItems: 'center', alignSelf: 'flex-end', backgroundColor: CourseColors.white, borderColor: CourseColors.border, borderRadius: 12, borderWidth: 1, flexDirection: 'row', gap: 5, minHeight: 40, paddingHorizontal: 11 }, statusFilterButtonText: { color: CourseColors.primaryDark, fontSize: 13, fontWeight: '800' }, statusFilterMenu: { backgroundColor: CourseColors.white, borderColor: CourseColors.border, borderRadius: 14, borderWidth: 1, marginTop: 5, minWidth: 158, overflow: 'hidden' }, statusFilterOption: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', minHeight: 42, paddingHorizontal: 12 }, statusFilterOptionText: { color: CourseColors.text, fontSize: 13, fontWeight: '700' }, statusFilterOptionSelected: { backgroundColor: CourseColors.primarySoft }, statusFilterOptionTextSelected: { color: CourseColors.primaryDark, fontWeight: '900' },
