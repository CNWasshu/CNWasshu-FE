...
const styles = StyleSheet.create({
  ...
  stepLabel: { alignSelf: 'flex-start', backgroundColor: CourseColors.primarySoft, borderRadius: 999, color: CourseColors.primaryDark, fontSize: 12, fontWeight: '900', marginTop: 8, overflow: 'hidden', paddingHorizontal: 10, paddingVertical: 6 },
  ...
  options: { gap: 9 },
  option: { backgroundColor: CourseColors.background, borderColor: CourseColors.border, borderRadius: 14, borderWidth: 1, gap: 4, minHeight: 50, justifyContent: 'center', paddingHorizontal: 16, paddingVertical: 11 },
  ...
  primaryButton: { alignItems: 'center', backgroundColor: CourseColors.primary, borderRadius: 15, justifyContent: 'center', minHeight: 52 },
