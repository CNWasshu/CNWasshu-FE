...
const styles = StyleSheet.create({
  ...
  error: { color: '#B84738', fontSize: 13, lineHeight: 18, marginTop: 8 },
  footer: { marginTop: 28 },
  ...
  label: { color: TIMETABLE_COLORS.secondaryText, fontSize: 14, fontWeight: '700' },
  ...
  summary: { color: TIMETABLE_COLORS.secondaryText, fontSize: 14, lineHeight: 20, marginTop: 10 },
  success: { color: TIMETABLE_COLORS.primary, fontSize: 14, fontWeight: '800', lineHeight: 20, marginTop: 8 },
