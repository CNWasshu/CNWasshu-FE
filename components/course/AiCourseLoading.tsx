...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: CourseColors.primary, fontSize: 12, fontWeight: '900', letterSpacing: 1.2 },
  title: { color: CourseColors.text, fontSize: 18, fontWeight: '900', textAlign: 'center' },
  description: { color: CourseColors.muted, fontSize: 14, lineHeight: 20, maxWidth: 360, textAlign: 'center' },
  ...
  stepText: { color: CourseColors.muted, fontSize: 14, fontWeight: '700' }, activeText: { color: CourseColors.primaryDark, fontWeight: '900' }, completedText: { color: CourseColors.text },
  stepDetail: { color: CourseColors.muted, fontSize: 12, lineHeight: 17 }, dots: { flexDirection: 'row', gap: 3 }, dot: { backgroundColor: CourseColors.primary, borderRadius: 3, height: 5, width: 5 }, faintDot: { opacity: 0.35 },
  ...
  tipText: { color: '#6F5B34', flex: 1, fontSize: 14, fontWeight: '700', lineHeight: 19 }, waitMessage: { color: CourseColors.muted, fontSize: 13, marginTop: 2, textAlign: 'center' },
});
