    ...
    <View style={styles.container}>
      ...
      {visibleGroups.map(([dayNo, dayItems]) => (
        <View key={dayNo} style={styles.day}>
          <View style={styles.dayHeading}><Text style={styles.dayTitle}>{dayNo}일차</Text><Text style={styles.dayCount}>{dayItems.length}개 일정</Text></View>
...
const styles = StyleSheet.create({
  container: { gap: 28 }, day: { gap: 10 }, dayHeading: { alignItems: 'baseline', borderBottomColor: '#E9DFCF', borderBottomWidth: 1, flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4, paddingBottom: 9 }, dayTitle: { fontSize: 18, fontWeight: '900', color: CourseColors.text }, dayCount: { color: CourseColors.muted, fontSize: 12, fontWeight: '700' },
  ...
  routeEntry: { gap: 2 }, routeRow: { flexDirection: 'row', gap: 12, alignItems: 'stretch' }, rail: { width: 28, alignItems: 'center' }, connector: { width: 1, flex: 1, minHeight: 12, backgroundColor: '#C9DBC6', marginTop: 4, marginBottom: -14 },
  item: { flex: 1, backgroundColor: CourseColors.white, borderRadius: 14, borderWidth: 1, borderColor: '#E9DFCF', paddingHorizontal: 16, paddingVertical: 14, gap: 6 },
  number: { width: 28, height: 28, borderRadius: 14, alignItems: 'center', justifyContent: 'center', backgroundColor: CourseColors.primary },
  numberText: { color: CourseColors.white, fontSize: 12, lineHeight: 14, fontWeight: '900', textAlign: 'center' }, timeRow: { alignItems: 'center', flexDirection: 'row', gap: 5, marginTop: 1 }, time: { color: CourseColors.primary, fontWeight: '800', fontSize: 13 }, title: { color: CourseColors.text, fontSize: 17, fontWeight: '900', lineHeight: 23 }, address: { color: CourseColors.muted, fontSize: 13, lineHeight: 19 },
  memo: { color: CourseColors.muted, lineHeight: 20, fontSize: 14 }, mapButton: { alignItems: 'center', alignSelf: 'flex-start', flexDirection: 'row', gap: 4, minHeight: 32, marginTop: 2 }, mapButtonText: { color: CourseColors.primaryDark, fontSize: 13, fontWeight: '800' }, travelRow: { alignItems: 'center', flexDirection: 'row', gap: 12, minHeight: 48 }, travelRail: { alignItems: 'center', width: 28 }, travelInfo: { alignItems: 'center', alignSelf: 'flex-start', flexDirection: 'row', gap: 8, marginVertical: 4, paddingVertical: 5 }, travelIcon: { alignItems: 'center', backgroundColor: '#F4F1E9', borderRadius: 15, height: 30, justifyContent: 'center', width: 30 }, travelEmoji: { fontSize: 18, lineHeight: 22 }, travelCopy: { gap: 1 }, travelLabel: { color: CourseColors.muted, fontSize: 11, fontWeight: '700' }, travelText: { color: CourseColors.text, fontSize: 13, fontWeight: '800' }, travelDistance: { color: CourseColors.muted, fontSize: 12, fontWeight: '700' }, empty: { alignItems: 'center', gap: 7, paddingVertical: 28 }, emptyTitle: { color: CourseColors.text, fontSize: 16, fontWeight: '900' }, emptyDescription: { color: CourseColors.muted, fontSize: 14, lineHeight: 20, textAlign: 'center' },
});
