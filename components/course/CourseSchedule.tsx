...
const styles = StyleSheet.create({
  ...
  memo: { color: CourseColors.muted, lineHeight: 18, fontSize: 12 }, mapButton: { alignItems: 'center', alignSelf: 'flex-start', backgroundColor: CourseColors.primarySoft, borderColor: '#D2E3CE', borderRadius: 999, borderWidth: 1, flexDirection: 'row', gap: 4, minHeight: 40, marginTop: 2, paddingHorizontal: 10 }, mapButtonText: { color: CourseColors.primaryDark, fontSize: 12, fontWeight: '800' }, travelRow: { alignItems: 'center', flexDirection: 'row', gap: 9, minHeight: 54 }, travelRail: { alignItems: 'center', width: 26 }, travelInfo: { alignItems: 'center', alignSelf: 'flex-start', backgroundColor: '#F2F7FC', borderColor: '#C9D9E8', borderRadius: 14, borderWidth: 1, flexDirection: 'row', gap: 9, marginVertical: 5, paddingHorizontal: 10, paddingVertical: 8 }, travelIcon: { alignItems: 'center', backgroundColor: CourseColors.white, borderColor: '#C9D9E8', borderRadius: 17, borderWidth: 1, height: 34, justifyContent: 'center', width: 34 }, travelEmoji: { fontSize: 20, lineHeight: 24 }, travelCopy: { gap: 1 }, travelLabel: { color: '#657B91', fontSize: 10, fontWeight: '700' }, travelText: { color: '#294E70', fontSize: 14, fontWeight: '900' }, travelDistance: { color: '#657B91', fontSize: 12, fontWeight: '800' }, empty: { alignItems: 'center', gap: 7, paddingVertical: 28 }, emptyTitle: { color: CourseColors.text, fontSize: 15, fontWeight: '900' }, emptyDescription: { color: CourseColors.muted, fontSize: 12, lineHeight: 18, textAlign: 'center' },
});
