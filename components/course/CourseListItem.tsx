...
const styles = StyleSheet.create({
  ...
  footer: { alignItems: 'center', borderTopColor: '#F2E8D7', borderTopWidth: 1, flexDirection: 'row', justifyContent: 'space-between', paddingTop: 10 }, pastFooter: { borderTopColor: '#DCDAD6' }, metaGroup: { alignItems: 'center', flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, itemCount: { color: CourseColors.muted, fontSize: 12, fontWeight: '700' },
